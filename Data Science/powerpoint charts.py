...
def presentation(fh):
    ...
    chart_data.categories = [l for l in fh1.columns]
    chart_data.add_series('Series 1', (k for k in fh1.iloc[0]))
    # add chart to slide --------------------
...
def presentation1():
    ...
    prs.save("C:/Users/user/Documents/2020-Kalkaal Speciality Hospital/Abdullah/Presentation {}1.pptx".format(today))
